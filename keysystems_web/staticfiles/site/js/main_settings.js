...
inputSettingsINN.setAttribute('value', mainData['inn'])
...
inputSettingsName.setAttribute('value', mainData['institution'])
...
inputSettingsReg.setAttribute('value', mainData['region'])
...
inputSettingsEmail.setAttribute('value', mainData['email'])
...
inputSettingsResponsible.setAttribute('value', mainData['full_name'])
...
inputSettingsPhone.setAttribute('value', mainData['phone'])
