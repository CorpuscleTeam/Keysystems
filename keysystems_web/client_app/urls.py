...
urlpatterns = [
    ...
    path('news/<int:pk>/', client.index_4_2, name='index_4_2'),  # /client/news/<номер публикации>
    ...
    path('upgrade/<int:pk>/', client.index_7_2, name='index_7_2'),  # /client/upgrade/<номер публикации>
