...
function addUpdateFile (arr) {
    ...
    updateFileLink.setAttribute('href', arr['url'])
    updateFileLink.setAttribute('download', arr['name']);
...
for (let i = 0; i < updateSoft72['update_files'].length; i++) {
    ...
    addUpdateFile (updateSoft72['update_files'][i])
